...
export function Features() {
    ...
    return (
        <section id="services" className="py-32 bg-[#020617] border-t border-white/5">
                ...
                <div className="flex flex-col md:flex-row justify-between items-end mb-20">
                    <div className="max-w-2xl">
                        ...
                        <h2 className="text-5xl md:text-7xl font-display text-white leading-tight tracking-widest">
                            JARDINES QUE <span className="text-[#FF7F50]">PERDURAN</span>
                        </h2>
                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-white/5 border border-white/5">
                    {services.map((service, index) => (
                        <motion.div
                            ...
                            className="group relative p-12 bg-[#020617] hover:bg-[#0f172a] transition-all duration-700"
                        >
                            <span className="font-mono text-[10px] text-[#FF7F50] mb-6 block opacity-60 tracking-widest">
                                SERVICIO {service.id}
                            </span>

                            <div className="text-[#FF7F50] mb-6">
